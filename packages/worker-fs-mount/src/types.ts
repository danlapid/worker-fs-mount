 ...
 */
export type MountableFilesystem =
  | WorkerFilesystem
  | SyncWorkerFilesystem
  | (WorkerFilesystem & SyncWorkerFilesystem);
...
export function hasAsyncMethods(fs: MountableFilesystem): fs is WorkerFilesystem {
  return (
    typeof (fs as WorkerFilesystem).stat === 'function' &&
...
export function hasSyncMethods(fs: MountableFilesystem): fs is SyncWorkerFilesystem {
  return (
    typeof (fs as SyncWorkerFilesystem).statSync === 'function' &&
